# ffmpeg-stream-delay-tool

Add a configurable delay to live streams.
...
### Example
```bash
docker compose run --rm ffmpeg-tool python app.py --dry-run rtmp://input/live rtmp://output/live --delay 30
```
